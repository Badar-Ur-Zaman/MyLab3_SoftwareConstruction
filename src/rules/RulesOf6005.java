...
public class RulesOf6005 {
    ...
    public static boolean mayUseCodeInAssignment(boolean writtenByYourself,
    	...
    	// If the code is written by yourself or your teammates, you can use it.
        if (writtenByYourself) {
            return true;
        }
        
        // If the code is not written by you:
        if (!writtenByYourself) {
            // If it's publicly available
            if (availableToOthers) {
                // You can only use it if it was coursework and you cited it
                return writtenAsCourseWork && citingYourSource;
            } else {
                // If it's not publicly available, you cannot use it
                return false;
            }
        }
        
        // In case none of the conditions are met, return false (though we shouldn't reach here)
        return false;
    }
